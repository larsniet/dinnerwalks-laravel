<x-action-section>
    <x-slot name="content">
        <div class="max-w-xl text-sm text-gray-900 dark:text-gray-300">
            {{ __('Als het nodig is, kan je jezelf uitloggen van alle apparaten die ingelogt waren vanuit andere browsers. Als je het idee hebt dat iemand je account ongeautoriseerd gebruikt, kan je ook je wachtwoord veranderen.') }}
        </div>
                            ...
                            <div>
                                <div class="text-xs text-gray-500">
                                    ...
                                    @if ($session->is_current_device)
                                        <span class="font-semibold text-green-500">{{ __('Dit apparaat') }}</span>
                                    @else
        ...
        <div class="flex items-center mt-5">
            <x-button wire:click="confirmLogout" wire:loading.attr="disabled">
                {{ __('Loguit van andere browser sessies') }}
            </x-button>
        ...
        <x-dialog-modal wire:model="confirmingLogout">
            ...
            <x-slot name="content">
                {{ __('Vul je wachtwoord in om te bevestigen dat je alle andere apparaten uit wil loggen.') }}
