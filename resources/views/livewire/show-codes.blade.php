    ...
    <x-form-section submit="addCode">
        <x-slot name="form">
            <div class="col-span-6 sm:col-span-4">
                <x-label for="discountCode" value="Kortingscode" />
                <x-input id="discountCode" type="text" class="block w-full mt-1" wire:model.defer="discountCode"
                            ...
                            <td class="px-4 py-3">
                                <div class="flex items-center space-x-4 text-sm">
                                    <button
                                        ...
                                        aria-label="Delete" wire:click="$emit('remove',{{ $discountCode }})">
