            ...
            <div class="flex flex-col overflow-y-auto md:flex-row">
                <div class="h-32 md:h-auto md:w-1/2">
                    <img aria-hidden="true" class="object-cover w-full h-full dark:hidden"
                        src="{{ asset('img/icon.png') }}" alt="Office" />
                ...
                <div class="flex items-center justify-center p-6 sm:p-12 md:w-1/2">
                    <div class="w-full">
                        ...
                        @if ($errors->any())
                            <div class="mb-4">
                                <div class="font-medium text-red-600">Whoops! Er is iets fout gegaan.</div>
                        ...
                        <form method="POST" action="{{ route('login') }}">
                            ...
                            <label class="block mt-4 text-sm">
                                <input type="checkbox" class="form-checkbox" name="remember"> <span
                                    class="ml-1 text-gray-700 dark:text-gray-400">{{ __('Onthouden') }}</span>
                            </label>
